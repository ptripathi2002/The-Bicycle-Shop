...
const server=http.createServer(async(req,res)=>{
    ...
    if(pathname==='/'){
        ...
        let html = await fs.readFile('./new/bicycles.html', 'utf-8');
        const AllMainBicycles=await fs.readFile('./new/bmain.html','utf-8');
        let allTheBicycles='';
    ...
    else if(/\.(svg)$/i.test(req.url))
    {
        ...
        let html = await fs.readFile('./new/overview.html', 'utf-8');
